    ...
    <div id="sambapress" class="container" style="background-color: #FFF; margin: 0;">
        <div class="header-line">
            <header class="grid_12 alpha omega">
                <a href="https://www.seosaGotmba.com/" target="_blank" class="logo fl-left mt5px">
            ...
            <div id="tabs-1" class="grid_12">
                <div class="callout mt15px">
                    ...
                    <p class="fs14 mb0px">
                        ...
                        </a> account with a valid email address.<br />
            ...
            <div class="callout mt15px">
                ...
                <ul type="disc">
                    ...
                    <li class="fs14">
                        ...
                        for top Google performances using a rule approach with our premium WordPress plugin.
                    </li>
                </ul>
            </div>
